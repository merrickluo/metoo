...
EGO_SUM=(
	...
	"github.com/Azure/go-ntlmssp v0.0.0-20180416175057-4b934ac9dad3 h1:r8SecdrDTMoF5DXQWYTAGv3Py8EnuxEOah49lc4E29o="
	...
	"github.com/marshallbrekka/go-u2fhost v0.0.0-20210111072507-3ccdec8c8105 h1:Si3VAYdC1ZtA58UsDXxlkbpF5EMWxoCJP9gn1cYQ+vc="
	"github.com/marshallbrekka/go-u2fhost v0.0.0-20210111072507-3ccdec8c8105/go.mod h1:VyqGj5jbZtzHO11cS7rkDh/owr/rNCEM98IhQwWvmXg="
...
SRC_URI="https://github.com/Versent/${PN}/releases/download/v${PV}/${PN}_${PV}_linux_${ARCH}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
https://github.com/Versent/saml2aws/releases/download/v2.33.0/saml2aws_2.33.0_linux_amd64.tar.gz
LICENSE="MIT"
SLOT="0"
